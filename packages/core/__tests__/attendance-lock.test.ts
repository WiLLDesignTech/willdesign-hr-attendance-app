...
import { AttendanceActions, AttendanceStates, AttendanceLockScopes, ErrorMessages } from "@willdesign-hr/types";
import type { AttendanceLock } from "@willdesign-hr/types";
