...
import { FlagLevels, AttendanceStates, CRON } from "@hr-attendance-app/types";
import type { AttendanceStateRecord, Employee, Flag, BankEntry } from "@hr-attendance-app/types";
